...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDWTx7bREpM5B6JKdbzOvMW-RRlhkukmVE&callback=initMap&libraries=&v=weekly" defer></script>
</head>
    ...
    if(!yii::$app->user->isGuest){
        if(\common\models\API_H17::isReporter()){
            $items=[["label" => "Trang chủ", "url" => ['site/index'], "icon" => "home"],
                ...
                ["label" => "Map", "url" => ["site/map"], "icon" => "map-marker"],
                ["label" => "Map", "url" => ["site/google-map"], "icon" => "map-marker"]];
        }
